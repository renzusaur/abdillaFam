      ...
      <?php if(isset($succ)) {?>
        ...
        <div class="card-body">
          ...
          <form method ="POST" enctype="multipart/form-data"> 
            ...
            <div class="form-group">
                <label for="exampleInputEmail1">Type of Cottage</label>
                <input type="text" class="form-control" id="exampleInputEmail1" name="v_pass_no">
            </div>
            <div class="form-group">
              <label for="exampleFormControlSelect1" hidden>Booker</label>
              <select class="form-control" name="a_name" id="exampleFormControlSelect1" hidden>
                <?php
            ...
            <div class="form-group col-md-12">
                <label for="exampleInputEmail1">Cottage Picture</label>
                <input type="file" class="btn btn-success" id="exampleInputEmail1" name="v_dpic">
            </div>

            <button type="submit" name="add_veh" class="btn btn-success">Add Cottage</button>
          </form>
          <!-- End Form-->
        </div>
      </div>
